...
export class OrderServiceBase {
  ...
  async AddOrder(args: OrderCreateInput): Promise<OrderCountArgs> {
    throw new Error("Not implemented");
  }
  async GetDeliveryStatus(args: string): Promise<OrderCountArgs> {
    throw new Error("Not implemented");
  }
  async UpdateOrderStatus(args: OrderUpdateInput): Promise<OrderCountArgs> {
    throw new Error("Not implemented");
  }
}

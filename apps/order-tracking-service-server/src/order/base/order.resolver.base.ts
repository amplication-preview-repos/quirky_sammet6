...
export class OrderResolverBase {
  ...
  @graphql.Mutation(() => OrderCountArgs)
  async AddOrder(
    @graphql.Args()
    args: OrderCreateInput
  ): Promise<OrderCountArgs> {
    return this.service.AddOrder(args);
  }

  @graphql.Query(() => OrderCountArgs)
  async GetDeliveryStatus(
    @graphql.Args("args")
    args: string
  ): Promise<OrderCountArgs> {
    return this.service.GetDeliveryStatus(args);
  }

  @graphql.Mutation(() => OrderCountArgs)
  async UpdateOrderStatus(
    @graphql.Args()
    args: OrderUpdateInput
  ): Promise<OrderCountArgs> {
